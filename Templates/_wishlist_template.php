            ...
            <div class="col-sm-9">
                ...
                ?>
                        ...
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="<?php echo $item['item_image_bdd'] ?? "./assets/products/1.png" ?>" alt="cart1" class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                        <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                        <button type="submit" name="cart-submit" class="btn font-mont text-danger">Ajouter au panier</button>
                                    </form>
                                </div>
                                <!-- !product qty -->
                            </div>
