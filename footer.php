        ...
        <!-- start #footer -->
        <footer id="footer" class="color-brown-bg text-white py-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <form class="row">
                            ...
                            <div class="col">
                                <button type="submit" class="btn color-second-bg text-light mb-2">Envoyer</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="copyright text-center color-second-bg text-white py-2 pt-3">
            <p class="font-mont font-size-14">&copy Copyrights 2022, Design By <a href="#" class="color-primary">Maxime Monnier</a></p>
        </div>
        <!-- !start #footer -->
